...
Author:         Sorob Cyrus
Description:    Creates Game Schema  
...
-------------------------------------------------------------------------------
SET @ErrorText = 'Failed CREATE SCHEMA Game.';
...
BEGIN
    SET @Message = 'SCHEMA Game already exist, skipping....';
    RAISERROR(@Message, 0,1) WITH NOWAIT;
END
ELSE
BEGIN
    EXEC sp_executesql N'CREATE SCHEMA Game';
    SET @Message = 'Completed CREATE SCHEMA Game.';
    RAISERROR(@Message, 0,1) WITH NOWAIT;
END
-------------------------------------------------------------------------------
